...
<body>
<p style="width:100px;height:20px;margin-left:1220px;margin-top: 5px;"><a href="index.jsp">返回主界面</a></p>
<div id="ibody">
    <form id="onload" action="<%=request.getContextPath()%>/login" method="post">
        <h2>图书管理系统登陆</h2>
        <p style="margin-top:70px;"><span style="font-size:16px;line-height:35px;">学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 号</span><input type="text" style="width:320px;
