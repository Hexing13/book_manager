...
<head>
  ...
  <link type="text/css" href="css/l_index.css" rel="stylesheet">
...
<body>
<div id="banner">
  <p id="data1"><a href="l_login.jsp">登陆</a> | <a href="l_exit.jsp">退出</a></p>
  <!--导航栏开始-->
  <div id="nav">
    <ul>
      <li><a href="#"><span>首页</span></a></li>
      <li><a href="#"><span>借书</span></a></li>
      <li><a href="#"><span>还书</span></a></li>
