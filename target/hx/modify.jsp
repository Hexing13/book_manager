...
<div id="ibody">
  <form id="onload" action="modifyed.jsp" method="post">
    <h2>图书管理修改信息</h2>
    ...
    <p style="width:500px;height:35px;" id="button">
      <input type="submit" style="width:100px;height:35px;line-height:35px;margin-left:170px;" name="regist" value="修改"/>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
