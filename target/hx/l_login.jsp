...
<body>
<p style="width:100px;height:20px;margin-left:1220px;margin-top: 5px;"><a href="l_index.jsp">返回主界面</a></p>
<div id="ibody">
  <form id="onload" action="<%=request.getContextPath()%>/l_login" method="post">
    <h2>图书管理系统登陆</h2>
