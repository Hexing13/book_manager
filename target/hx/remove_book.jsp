...
<div id="ibody">
  <form id="onload" action="<%=request.getContextPath()%>/remove_book" method="post">
    <h2>删除图书</h2>
    <p style="margin-top:70px;"><span style="font-size:16px;line-height:35px;">书&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 号</span><input type="text" style="width:320px;
	height:35px;" name="bid" /></p>
