...
<body>
<div id="banner">
  <p id="data1"><a href="m_login.jsp">登陆</a> | <a href="m_exit.jsp">退出</a></p>
  <ul id="ul1">
    <li><a href="#"><span>添加管理员</span></a></li>
    <li><a href="#"><span>删除管理员</span></a></li>
    <li><a href="#"><span>添加图管</span></a></li>
    <li><a href="#"><span>删除图管</span></a></li>
    <li><a href="#"><span>添加学生</span></a></li>
    <li><a href="#"><span>删除学生</span></a></li>
    <li><a href="#"><span>添加学生</span></a></li>
    <li><a href="#"><span>删除学生</span></a></li>
    <li><a href="#"><span>验证</span></a></li>
