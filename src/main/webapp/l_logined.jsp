...
<%
  String sname = (String) request.getAttribute("name1");
    if(session.getAttribute("flag1") == null) {
      session.setAttribute("flag1", "on");
      session.setAttribute("snum", "");
     session.setAttribute("snum",session.getAttribute("snum")+sname);
  }

%>

<div id="banner">
  <p id="data1">欢迎<span style="color: #E94D38"><%=session.getAttribute("snum")%></span>登陆 | <a href="l_exit.jsp">退出</a></p>
  <!--导航栏开始-->
  <div id="nav">
    <ul>
      <li><a href="#"><span>首页</span></a></li>
      <li><a href="borrow.jsp"><span>借书</span></a></li>
      <li><a href="return.jsp"><span>还书</span></a></li>
      <li><a href="help.jsp"><span>入馆须知</span></a></li>
    </ul>
  </div>
</div>
<!--导航栏结束-->
