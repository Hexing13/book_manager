...
<body>
<div id="banner">
  <p id="data1"><a href="login.jsp">登陆</a> | <a href="regist.jsp">注册</a></p>
  <!--搜索框开始-->
  <div class="search">
    <%--<img src="images/zoom.png" width="30" height="30" style="float:left;padding-left:8px;" />--%>
    <form action="display_query.jsp" method="post">
     <input id="find" type="text" name="squery" value="图书的名字、作者、编号" />
